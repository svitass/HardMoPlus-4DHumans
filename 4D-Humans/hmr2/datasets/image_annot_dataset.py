...
class ImageDataset_annot(Dataset):
    def __init__(self,
                 cfg: CfgNode,
                 dataset_file: str,
                 img_dir: str,
        ...
        """
        super(ImageDataset_annot, self).__init__()
        self.train = train
        self.cfg = cfg
        ...
        print("imgname", self.imgname)
        print("imgname", self.imgname[0])
    ...
    def __getitem__(self, idx: int) -> Dict:
        ...
        center_x = center[0]
        center_y = center[1]
        ###这个地方我们恢scale参数,训练hmr时候不除以2.0, annot的时候都是除了这东西的，但是训练的时候没有除
        scale = self.scale[idx]/1.2
