...
class ImageDataset_half(Dataset):
    ...
    def __init__(self,
        ...
        """
        super(ImageDataset_half, self).__init__()
        self.train = train
        self.cfg = cfg
    ...
    def load_tars_as_webdataset(cfg: CfgNode, urls: Union[str, List[str]], train: bool,
        ...
        dataset = dataset.map(lambda x: ImageDataset_half.process_webdataset_tar_item(x, train,
