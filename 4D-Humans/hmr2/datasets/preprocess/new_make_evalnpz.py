import sys
sys.path.append("/data/boning_zhang/4D-Humans")
import os
import pickle
import numpy as np
import glob
...
"""
# path = "/data/boning_zhang/Freeman/test_annot_new_add_3dkp_right.npz"
# path = "/data/boning_zhang/Freeman/foot_annot.npz"
# path = "/data/boning_zhang/Freeman/freeman_eval.npz"
# data = np.load(path, allow_pickle=True)
# for key in data:
#     value = data[key]
#     print(f"{key},  shape:{value.shape}")
# imgname = data["imgname"]    #  图片43016
# center = data["center"]
# scale = data["scale"]
...
# body_keypoints_2d = data["body_keypoints_2d"]
# extra_keypoints_2d = data["extra_keypoints_2d"]
# body_keypoints_3d = data["body_keypoints_3d"]
# extra_keypoints_3d = data["extra_keypoints_3d"]
# print("imgname:", imgname)

eval_data_root ="/data/boning_zhang/data/freeman_score_hamer_test_hardsample"
eval_jpg_list = glob.glob(eval_data_root + "/*.jpg")
npz_path = "/data/boning_zhang/data/freeman_score_hamer_test.npz"
npz_data_dict = {}
imgname_list = []
center_list = []
scale_list = []
...
extra_kps3d_list = []
smpl_cfg = {}
smpl_cfg['model_path'] = '/data/boning_zhang/.cache/4DHumans/data/smpl'
smpl_cfg['gender'] = 'neutral'
smpl_cfg['num_body_joints'] = 23
smpl_cfg['joint_regressor_extra'] = '/data/boning_zhang/.cache/4DHumans/data/SMPL_to_J19.pkl'
smpl_cfg['mean_params'] = '/data/boning_zhang/.cache/4DHumans/data/smpl_mean_params.npz'
smpl = SMPL(**smpl_cfg)
...
npz_data_dict["center"] = np.array(center_list)   # (nframes, 2)
npz_data_dict["scale"] = np.array(scale_list)  # (nframes, 2)
