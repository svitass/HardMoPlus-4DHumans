...
from .image_siamese_dataset import SiameseImageDataset
from .mocap_dataset import MoCapDataset
from .image_dataset_half import ImageDataset_half
...
class HMR2Data_Annot_Module(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        #     self.train_dataset = create_dataset(self.cfg, self.dataset_cfg["HALF"], train=False)
        #     self.val_dataset = create_dataset(self.cfg, self.dataset_cfg["HALF"], train=False)
