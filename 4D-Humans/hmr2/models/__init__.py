...
def load_hmr2(checkpoint_path=DEFAULT_CHECKPOINT, rank="cuda:0"):
    ...
    check_smpl_exists()
    model = HMR2.load_from_checkpoint(checkpoint_path, strict=False, cfg=model_cfg, map_location=rank)
