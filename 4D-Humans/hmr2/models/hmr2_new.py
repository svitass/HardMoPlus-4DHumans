...
class HMR2(pl.LightningModule):
    ...
    def compute_loss(self, batch: Dict, output: Dict, train: bool = True) -> torch.Tensor:
        ...
        print("loss_keypoints_3d:", loss_keypoints_3d.detach())
        print("loss_keypoints_2d:", loss_keypoints_2d.detach())
        ...
        return loss
    def compute_4rot_loss(self, batch: Dict, output: Dict, train: bool = True) -> torch.Tensor:
        """
        Compute losses given the input batch and the regression output
        Args:
            batch (Dict): Dictionary containing batch data
    ...
    def tensorboard_logging(self, batch: Dict, output: Dict, step_count: int, train: bool = True, write_to_summary_writer: bool = True) -> None:
        ...
        #print("gt_keypoints_2d.shape:", gt_keypoints_2d.shape)
        #print("pred_keypoints_2d.shape:", pred_keypoints_2d.shape)
        ## 查看keypoints_3d end
