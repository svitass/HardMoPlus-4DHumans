...
###这里先修改一下
    def __init__(self, cfg: CfgNode, init_renderer: bool = True):
        ...
        self.has_gt_hand_keypoints_2d = False
    ...
    def forward_step(self, batch: Dict, train: bool = False) -> Dict:
        ...
        original_3d_keypoints = smpl_output.original_joints
        output['pred_keypoints_3d'] = pred_keypoints_3d.reshape(batch_size, -1, 3)
        output['ori_pred_keypoints_3d'] = original_3d_keypoints
        ...
        original_pred_keypoints_2d = perspective_projection(original_3d_keypoints,
                                                   translation=pred_cam_t,
                                                   focal_length=focal_length / self.cfg.MODEL.IMAGE_SIZE)

        output['pred_keypoints_2d'] = pred_keypoints_2d.reshape(batch_size, -1, 2)
        output['original_pred_keypoints_2d'] = original_pred_keypoints_2d.reshape(batch_size, -1, 2)
        return output

    def forword_for_recovery(self, token, train: bool = False) -> Dict:
        batch_size = token.shape[0]
        pred_smpl_params, pred_cam, _ = self.smpl_head(token)
    ...
    def compute_loss(self, batch: Dict, output: Dict, train: bool = True) -> torch.Tensor:
        ...
        try:
            ...
            gt_hand_keypoints_2d = None
            self.has_gt_hand_keypoints_2d = False

        try:
            gt_hand_wrist_kp_3d = gt_keypoints_3d[:,[4,7]]
            pred_hand_wrist_kp_3d = pred_keypoints_3d[:,[4,7]]
            gt_pelvis = gt_keypoints_3d[:,25+14].unsqueeze(1)
            pred_pelvis = pred_keypoints_3d[:,25+14].unsqueeze(1)
            gt_hand_keypoints_3d = torch.cat((gt_pelvis, gt_hand_wrist_kp_3d,batch['hand_keypoints_3d']), dim=1)
            pred_hand_keypoints_3d = torch.cat((pred_pelvis, pred_hand_wrist_kp_3d, output["ori_pred_keypoints_3d"][:,-10:]), dim=1)
            self.has_gt_hand_keypoints_3d = True
        except Exception as s:
            gt_hand_keypoints_3d = None
            self.has_gt_hand_keypoints_3d = False
        ...
        if self.has_gt_hand_keypoints_2d:
            loss_hand_keypoints_2d = self.keypoint_2d_loss(pred_hand_keypoints_2d, gt_hand_keypoints_2d)
        if self.has_gt_hand_keypoints_3d:
            loss_hand_keypoints_3d = self.keypoint_3d_loss(pred_hand_keypoints_3d, gt_hand_keypoints_3d, pelvis_id=0)
        # Compute loss on SMPL parameters
        loss_smpl_params = {}
        for k, pred in pred_smpl_params.items():
            gt = gt_smpl_params[k].view(batch_size, -1)
            if is_axis_angle[k].all():
                #print("axis angle", gt.shape)
        ...
        if self.has_gt_hand_keypoints_2d and self.has_gt_hand_keypoints_3d:
            loss = self.cfg.LOSS_WEIGHTS['KEYPOINTS_3D'] * loss_keypoints_3d+\
                self.cfg.LOSS_WEIGHTS['KEYPOINTS_2D'] * loss_keypoints_2d+\
                sum([loss_smpl_params[k] * self.cfg.LOSS_WEIGHTS[k.upper()] for k in loss_smpl_params])+\
                self.cfg.LOSS_WEIGHTS['HAND_KEYPOINTS_2D'] * loss_hand_keypoints_2d+\
                self.cfg.LOSS_WEIGHTS['HAND_KEYPOINTS_3D'] * loss_hand_keypoints_3d
        
        elif self.has_gt_hand_keypoints_2d and not self.has_gt_hand_keypoints_3d:
            loss = self.cfg.LOSS_WEIGHTS['KEYPOINTS_3D'] * loss_keypoints_3d+\
                self.cfg.LOSS_WEIGHTS['KEYPOINTS_2D'] * loss_keypoints_2d+\
                sum([loss_smpl_params[k] * self.cfg.LOSS_WEIGHTS[k.upper()] for k in loss_smpl_params])+\
                self.cfg.LOSS_WEIGHTS['HAND_KEYPOINTS_2D'] * loss_hand_keypoints_2d
        
        elif self.has_gt_hand_keypoints_3d and not self.has_gt_hand_keypoints_2d:
            loss = self.cfg.LOSS_WEIGHTS['KEYPOINTS_3D'] * loss_keypoints_3d+\
                self.cfg.LOSS_WEIGHTS['KEYPOINTS_2D'] * loss_keypoints_2d+\
                sum([loss_smpl_params[k] * self.cfg.LOSS_WEIGHTS[k.upper()] for k in loss_smpl_params])+\
                self.cfg.LOSS_WEIGHTS['HAND_KEYPOINTS_3D'] * loss_hand_keypoints_3d
        ...
        if self.has_gt_hand_keypoints_2d and self.has_gt_hand_keypoints_3d:
            losses = dict(loss=loss.detach(),
                        loss_hand_keypoints_2d=loss_hand_keypoints_2d.detach(),
                        loss_hand_keypoints_3d=loss_hand_keypoints_3d.detach(),
    ...
    def training_step(self, joint_batch: Dict, batch_idx: int) -> Dict:
        ...
        if self.has_gt_hand_keypoints_2d:
            self.log('train_hand_2d/loss', output['losses']['loss_hand_keypoints_2d'], on_step=True, on_epoch=True, prog_bar=True, logger=False)
        if self.has_gt_hand_keypoints_3d:
            self.log('train_hand_3d/loss', output['losses']['loss_hand_keypoints_3d'], on_step=True, on_epoch=True, prog_bar=True, logger=False)
