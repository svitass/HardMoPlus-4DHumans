...
from .backbones import create_backbone, create_hmr_backbone
from .heads import build_smpl_head, build_smpl_hmr_head
...
###这里先修改一下
    def __init__(self, cfg: CfgNode, init_renderer: bool = True):
        ...
        self.backbone = create_hmr_backbone(cfg)
        
        # Create SMPL head
        self.smpl_head = build_smpl_hmr_head(cfg)
    ...
    def training_step(self, joint_batch: Dict, batch_idx: int) -> Dict:
        ...
        if self.has_gt_hand_keypoints_2d:
            self.log('train_hand/loss', output['losses']['loss_hand_keypoints_2d'], on_step=True, on_epoch=True, prog_bar=True, logger=False)
