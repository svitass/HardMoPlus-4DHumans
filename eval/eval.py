...
from hmr2.models import HMR2, download_models, load_hmr2,check_smpl_exists, DEFAULT_CHECKPOINT
...
def main():
    ...
    model, model_cfg = load_hmr2("/data/boning_zhang/4D-Humans/logs/finetune_on_only_ubody/runs/hmr2/checkpoints/last.ckpt")
...
def run_eval(model, model_cfg, dataset_cfg, device, args):
    ...
    if args.dataset in ['H36M-VAL-P2','3DPW-TEST','HALFTEST']:
