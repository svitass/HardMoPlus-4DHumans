...
from smplx.body_models import SMPLHLayer as _SMPLHLayer
...
SMPLH_MODEL_PATH="/data/boning_zhang/hamer/data/smpl/SMPLH_NEUTRAL.pkl"
JOINT_REGRESSOR_TRAIN_EXTRA="/data/boning_zhang/PyMAF-X/data/J_regressor_extra.npy"
...
class SMPLH(_SMPLHLayer):
    """ Extension of the official SMPLH implementation to support more joints """

    def __init__(self, model_path=SMPLH_MODEL_PATH, ext="pkl", **kwargs):
        kwargs["model_path"] = model_path

        # remove the verbosity for the 10-shapes beta parameters
        with contextlib.redirect_stdout(None):
            super(SMPLH, self).__init__(**kwargs)
    ...
    def forward(self, *args, **kwargs):
        ...
        #output["smplh"]=smpl_output.joints
...
# class SMPLH(_SMPLHLayer):
#     def __init__(self, model_path=SMPLH_MODEL_PATH, ext="pkl",jointstype="smplh", gender="male", **kwargs):
#         kwargs["model_path"] = model_path
...
#         with contextlib.redirect_stdout(None):
#             self.smplh = SMPLHLayer(model_path, ext="pkl", gender=gender).eval()
...
#         smpl_output = self.smplh(global_orient=global_orient,
#                                     body_pose=body_pose,
