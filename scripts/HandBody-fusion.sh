#!/bin/bash
# 要删除的文件的路径
file_to_delete1="/data/boning_zhang/blend_body_hand_pipline/4dhuman_out.pkl"
file_to_delete2="/data/boning_zhang/blend_body_hand_pipline/hamer_out.pkl"
...
CUDA_VISIBLE_DEVICES=7 python demo_onlyone.py --img_folder /data/boning_zhang/blend_body_hand_pipline/example_vis --batch_size=48 --save_smpl --checkpoint "$checkpoint_human4d"

conda deactivate #这个是必要的，要不然出错
# Activate the second conda environment
source activate hamer

# Run the second Python script
cd /data/boning_zhang/hamer/
CUDA_VISIBLE_DEVICES=7 python demo_onlyone.py --img_folder /data/boning_zhang/blend_body_hand_pipline/example_vis  --batch_size=48 --save_smpl
